...
│   ├── params_selector.hpp     # parameter-set selector; defaults to params_v1.hpp
│   ├── params_v1.hpp           # accepted-paper LUNA+ parameters of HGSW
│   ├── params_v2.hpp           # faster LUNA+ parameters of HGSW
